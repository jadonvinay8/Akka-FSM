...
import static com.example.fsm.Events.*;
import static com.example.fsm.PaymentFSM.*;
import static com.example.fsm.PaymentFSM.PaymentState.*;


public class PaymentFSM extends AbstractFSM<PaymentState, PaymentData> {
